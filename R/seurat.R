...
#================================== DEG List==============================#
UUO.Control.Project.Markers <- FindAllMarkers(UUO.Control.Project, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
...
#================================== DEG List=====================================#
UUO.Control.Project.Subset.Markers <- FindAllMarkers(UUO.Control.Project.Subset, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25, test.use = "MAST")
...
Human.Control.CKD.Markers <- FindAllMarkers(Human.Control.CKD, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25, test.use = "MAST")